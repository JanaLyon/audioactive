...
$number_of_posts = 5; //$hero_query->post_count;
$counter = 0;
?>

<div id="slider" class="carousel slide" data-interval="6000" data-ride="carousel">
  <!-- Indicators -->
  ...
  ?>
		<div class="hero-module">
			...
			<div class="col-xs-12 col-md-3 shorten-for-controls carousel-height">
